...
<center>  
 ...
 echo "Trends data is not available. The indicators aggregation has not been activated for server ".$ServerName.".<P> (Add RSTrends.xml in the asemon_logger config file)";
        exit();
...
<a   href="http://sourceforge.net/apps/mediawiki/asemon?title=AseRep_Trends" TARGET="_blank"> <img class="help" SRC="images/Help-circle-blue-32.png" ALT="Trends help" TITLE="Trends help"  /> </a>
</div>
