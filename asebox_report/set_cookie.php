...
<?php
    ...
    print "<b>SESSIONS</b><br>";
    print "<div>SESSION.asebox_contact="   . $_SESSION["asebox_contact"]   . "</div>";   
    print "<div>SESSION.asebox_firstname=" . $_SESSION["asebox_firstname"] . "</div>";   
    print "<div>SESSION.asebox_lastname="  . $_SESSION["asebox_lastname"]  . "</div>";   
    print "<br>";
    
    if (( $contact !== "" ) and ( ! empty( $contact ) ))  {
       ...
       print "<b>COOKIES</b><br>";
       print "<div>COOKIE2.asebox_contact="   . $_COOKIE["asebox_contact"]   . "</div>";   
       print "<div>COOKIE2.asebox_firstname=" . $_COOKIE["asebox_firstname"] . "</div>";   
       print "<div>COOKIE2.asebox_lastname="  . $_COOKIE["asebox_lastname"]  . "</div>";   
       print "<br>";
       
       print "<b>SESSIONS</b><br>";
       print "<div>SESSION2.asebox_contact="   . $_SESSION["asebox_contact"]   . "</div>";   
       print "<div>SESSION2.asebox_firstname=" . $_SESSION["asebox_firstname"] . "</div>";   
       print "<div>SESSION2.asebox_lastname="  . $_SESSION["asebox_lastname"]  . "</div>";   
       print "<br>";
