<?php
  ...
  include ("../connectArchiveServer.php");	
	...
	include ("../".$jpgraph_home."/src/jpgraph_line.php");
		...
		$result=sybase_query(
"select Ts=convert(varchar,Timestamp,3)+' '+convert(varchar,Timestamp,108), activecnx=count(*) 
...
order by Timestamp",
 $pid);
		...
		$graph->title->Set("Number of active connections");
