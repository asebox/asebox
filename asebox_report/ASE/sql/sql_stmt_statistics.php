  ...
  if ($support157 ==1) {
   ...
   if ($orderStmt=="Debut") {
    ...
    ";
        ...
        // AR 20120720
        $query = $query . "and isnull(Application,'') <> 'asemon_logger' ";
        $query = $query . "and isnull(ProcName,'') not like 'sp_asemon_%' ";
        $query = $query . "and isnull(ProcName,'') <> 'sp_dba_upstats_thread' ";
