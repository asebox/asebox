...
<table cellspacing=2 cellpadding=4>
    ...
    <tr>  
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="1"      <?php if ($orderFragment=="4")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="2"      <?php if ($orderFragment=="5")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="3"      <?php if ($orderFragment=="2")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="4  DESC"      <?php if ($orderFragment=="7  DESC")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="5  DESC"      <?php if ($orderFragment=="8  DESC")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="6  DESC"      <?php if ($orderFragment=="9  DESC")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="7 DESC"      <?php if ($orderFragment=="10 DESC")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="8 DESC"      <?php if ($orderFragment=="11 DESC")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="9 DESC"      <?php if ($orderFragment=="12 DESC")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="10 DESC"      <?php if ($orderFragment=="13 DESC")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="11"      <?php if ($orderFragment=="14")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="12"      <?php if ($orderFragment=="15")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="13"      <?php if ($orderFragment=="16")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="14"      <?php if ($orderFragment=="17")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="15"      <?php if ($orderFragment=="18")      echo "CHECKED";  ?> > </td>
      <td  class="statTableBtn"> <INPUT TYPE=radio NAME="orderFragment"  VALUE="16"      <?php if ($orderFragment=="19")      echo "CHECKED";  ?> > </td>
