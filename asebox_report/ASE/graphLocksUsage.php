<?php
  ...
  include ("../connectArchiveServer.php");	
	...
	include ("../".$jpgraph_home."/src/jpgraph_line.php");
		...
		$result=sybase_query(
"select Timestamp=convert(varchar,Timestamp,3)+' '+convert(varchar,Timestamp,108), Num_Active, Max_used , ConfigLocks=Num_Free+Num_Active
