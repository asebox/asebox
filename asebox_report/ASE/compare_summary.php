...
//Server 2
$query = "select cnt=count(*)
          from ".$ServerName2."_Engines          
          where Timestamp >='".$StartTimestamp2."'
          and Timestamp <'".$EndTimestamp2."'";
...
<!-- Graphs -->
          ...
          <div  style="overflow:visible" class="imginmain">
	        ...
	        <img src='<?php echo "./ASE/graphCPU.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=1"; ?> '></br>
	        <img src='<?php echo "./ASE/graphCPU.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=2"; ?> '>

	        <img src='<?php echo "./ASE/graphCache.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=1"; ?> '></br>
	        <img src='<?php echo "./ASE/graphCache.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=2"; ?> '>

	        <img src='<?php echo "./ASE/graphIO.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=1"; ?> '></br>
	        <img src='<?php echo "./ASE/graphIO.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=2"; ?> '>
   ...
   <img src='<?php echo "./ASE/graphPieProcess.php?group=program&indicator=cpu&filter_clause=&ARContextJSON=".urlencode($ARContextJSON); ?> '>
	        ...
	        <img src='<?php echo "./ASE/graphActiveCnx.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=1"; ?> '></br>
	        <img src='<?php echo "./ASE/graphActiveCnx.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=2"; ?> '>
	        
	        <img src='<?php echo "./ASE/graphProcCacheUsage.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=1"; ?> '></br>
	        <img src='<?php echo "./ASE/graphProcCacheUsage.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=2"; ?> '>

	        <img src='<?php echo "./ASE/graphRecompProcs.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=1"; ?> '></br>
	        <img src='<?php echo "./ASE/graphRecompProcs.php?ARContextJSON=".urlencode($ARContextJSON)."&SrvNum=2"; ?> '>
	        ...
	        <img src='<?php echo "./ASE/graphLocksUsage.php?	=".urlencode($ARContextJSON); ?> '>
	      </DIV>
        ...
        if ($row["cnt"] == 1) {
          ...
          echo "<P>";
	        include ("SysWaits_statistics.php");
          echo "</P>";
          
          echo "<P align='center'>";
	        include ("cache_statistics.php");
          echo "</P>";
          ...
          echo "<P align='center'>";
	        include ("logscontention_statistics.php");
          echo "</P>";
